...
## E. Conteúdo & UX
- [ ] 🟡 Confirmar **preços/textos** da `/planos` (Aprenda R$49,90 · Mentor IA R$29,90/mês · Evolua R$99,90). Editáveis em `/admin` → **Textos da página de Planos** (não precisa deploy).
